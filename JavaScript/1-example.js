...
writeApi.createAccount('Marcus Aurelius');
writeApi.operation('Marcus Aurelius', 1000);
writeApi.operation('Marcus Aurelius', -50);
writeApi.createAccount('Antoninus Pius');
writeApi.operation('Antoninus Pius', 500);
writeApi.operation('Antoninus Pius', -100);
writeApi.operation('Antoninus Pius', 150);

const res1 = readApi1.select({ account: 'Marcus Aurelius' });
console.table(res1);

const res2 = readApi2.select({ account: 'Antoninus Pius', operation: 'Income' });
console.table(res2);
